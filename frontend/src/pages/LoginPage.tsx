      ...
      <div className="hidden lg:flex lg:w-1/2 bg-card border-r border-border p-12 flex-col justify-between">
        ...
        <div>
          <h1 className="font-heading font-bold text-4xl mb-4">
            Welcome back to
            <br />
            <span className="text-primary">your command center</span>
          </h1>
          <p className="text-muted-foreground">
            Manage your AI chatbots, monitor analytics, and deploy updates.
          </p>
        </div>

        <div className="flex items-center gap-4">
          <img
            src="https://images.unsplash.com/photo-1737505599162-d9932323a889?w=400&q=80"
            alt="AI Network"
            className="w-16 h-16 rounded-lg object-cover border border-border"
          />
          <div>
            <p className="text-sm font-medium">Enterprise-Grade RAG</p>
            <p className="text-xs text-muted-foreground">Secure, scalable, reliable</p>
          </div>
        </div>
      </div>
